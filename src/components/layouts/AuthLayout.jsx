    ...
    <div className=" w-screen h-screen border-2 border-blue-800 bg-[url('/images/17178.jpg')] bg-cover bg-center">
      <div className="flex flex-col w-full h-full border-2 border-pink-500">
        ...
        <div className="flex-1 w-full border-2 border-black ">
          <div className="flex items-center justify-center w-full border-2 border-pink-500 lg:w-1/2 h-5/6">
            <div
          ...
          <div className="flex items-end justify-end w-full border border-white h-1/6">
            <PromoBanner />
          </div>
        </div>
      </div>
...
const Navigation = () => {
  ...
  return (
    <div className="my-4 text-center 2xl:my-6">
      ...
      <Link
        to={"/signin"}
        className={`mx-1 lg:text-base 2xl:text-xl font-semibold tracking-wide font-Poopins ${
          location.pathname === "/"
...
{
  /* <div className="flex items-center justify-center flex-1 w-full border-2 border-black">
<div className="w-11/12 border-2 border-white lg:w-2/5">
  <div
    className="flex flex-col items-center justify-center w-full bg-white lg:w-3/5 rounded-xl 2xl:ml-20"
    style={{
      boxShadow: isHover ? "2px 2px 8px rgba(0,0,0,0.6)" : "none",
      transition: "box-shadow 0.3s ease-in-out",
    }}
